...
const INITIAL_DATA = Array.from({ length: 108 }, (_, i) => ({
  id: i + 1,
  code: `M${1200 + (i % 20)}`,
  name: ["Dell", "Apple", "Epson", "Sony", "Keychron", "Samsung", "LG", "HP"][
    i % 8
  ],
...
function BrandModal({ mode, initial, onClose, onSave }) {
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <h2 className="text-base font-medium text-gray-800">
            {mode === "add" ? "Thêm hãng" : "Chỉnh sửa hãng"}
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5 flex flex-col gap-4">
          {[
            { label: "Mã hãng", field: "code", placeholder: "VD: M1215" },
            { label: "Tên hãng", field: "name", placeholder: "VD: Dell" },
